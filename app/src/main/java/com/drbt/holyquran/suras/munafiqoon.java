...
public class munafiqoon extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_munafiqoon);
...
//
    ...
    String readLine ( int line)throws IOException {
        ...
        InputStream in = getResources().openRawResource(R.raw.munafiqoon);
