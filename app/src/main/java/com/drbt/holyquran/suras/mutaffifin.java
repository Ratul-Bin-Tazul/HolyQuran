...
public class mutaffifin extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mutaffifin);
...
//
    ...
    String readLine ( int line)throws IOException {
        ...
        InputStream in = getResources().openRawResource(R.raw.mutaffifin);
