...
public class mumtahanah extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mumtahanah);
...
//
    ...
    String readLine ( int line)throws IOException {
        ...
        InputStream in = getResources().openRawResource(R.raw.mumtahanah);
